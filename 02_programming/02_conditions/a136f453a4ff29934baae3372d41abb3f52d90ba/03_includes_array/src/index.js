...
isTheComputedOneInOurNumbers === true ? console.log(`The Answer to the Ultimate Question of Life, the Universe, and Everything is ${theComputedOne}`) : console.log("I always thought something was fundamentally wrong with the universe.") ;
